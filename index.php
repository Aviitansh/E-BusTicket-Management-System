...
<body>
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">eBusTicket</a>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>eBusTicket Management System</h1>

            <p class="text-center">Welcome to eBusTicket Management System. Login now to manage bus tickets and much more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>
    ...
    <div id="block">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - eBusTicket Management System | Made by Avitansh & Group
                        </p>
        </footer>
    </div>
